...
class IsNaturalValidatorTest extends ValidatorTestCase
{
    public function testValidate()
    {
        $validator = new Validators\IsNaturalValidator();
        ...
        $this->assertEquals('simple_form.errors.is_natural', $error);
