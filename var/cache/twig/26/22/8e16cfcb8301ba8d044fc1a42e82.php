...
class __TwigTemplate_26228e16cfcb8301ba8d044fc1a42e82 extends Twig_Template
{
...
";
    ...
    <dd name=\"\" style=\"margin-left: 100px;\">
        ...
        // line 12
        echo twig_escape_filter($this->env, $this->getContext($context, "user_id"), "html", null, true);
        echo "\" target=\"_new\">";
    ...
    <dd name=\"\" style=\"margin-left: 100px;\">
        ";
        // line 22
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getContext($context, "last_login"), "Y-m-d H:i:s"), "html", null, true);
        echo "
    </dd>
</dl>
";
