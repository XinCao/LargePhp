...
class __TwigTemplate_31442492b5db287e061022405c101d96 extends Twig_Template
{
    ...
    public function block_sidebar_menu_body($context, array $blocks = array())
    {
        ...
        // line 16
        echo "  ";
        echo $this->env->getExtension('knp_menu')->render("DreamHeavenAdminBundle:MenuBuilder:build", array("currentClass" => "active", "menu" => (isset($context["menu"]) ? $context["menu"] : $this->getContext($context, "menu"))));
        echo "
";
    }
