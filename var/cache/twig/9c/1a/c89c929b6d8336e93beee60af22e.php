...
class __TwigTemplate_9c1ac89c929b6d8336e93beee60af22e extends Twig_Template
{
  ...
  <form class=\"form form-horizontal\" method=\"POST\" action=\"";
    ...
    <fieldset>
      ...
      <table id=\"realms\" class=\"table table-bordered\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "realms"));
        foreach ($context['_seq'] as $context["_key"] => $context["realm"]) {
            // line 47
            echo "            <tr>
              <td><input name=\"selected_ids[]\" value=\"";
            // line 48
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "id"), "html", null, true);
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "id"), "html", null, true);
            echo ":num\" value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "realm_num"), "html", null, true);
            echo "\" type=\"text\" class=\"input-small\" /></td>
              <td><input name=\"";
            // line 51
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "id"), "html", null, true);
            echo ":name\" value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "name"), "html", null, true);
            ...
            foreach ($context['_seq'] as $context["type"] => $context["type_name"]) {
                ...
                echo "\"";
                echo ((($this->getAttribute($this->getContext($context, "realm"), "type") == $this->getContext($context, "type"))) ? (" selected=\"selected\"") : (""));
                echo ">";
                echo twig_escape_filter($this->env, $this->getContext($context, "type_name"), "html", null, true);
                echo "</option>
                      ";
            }
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "id"), "html", null, true);
            echo ":address\" value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "address"), "html", null, true);
            echo "\" type=\"text\" class=\"input-medium\" /></td>
              <td><input name=\"";
            // line 61
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "id"), "html", null, true);
            echo ":mgmt_address\" value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "realm"), "mgmt_address"), "html", null, true);
            echo "\" type=\"text\" class=\"input-medium\" /></td>
            </tr>
          ";
        }
