...
class __TwigTemplate_574da1a000c698dc3d09e0ebc258b368 extends Twig_Template
{
    ...
    {
        // line 2
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session")) {
            // line 3
            echo "    ";
            $context["flashBag"] = $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "getFlashBag", array(), "method");
            // line 4
            echo "    ";
            $context["flashes"] = $this->getAttribute((isset($context["flashBag"]) ? $context["flashBag"] : $this->getContext($context, "flashBag")), "all", array(), "method");
            // line 5
            echo "    ";
